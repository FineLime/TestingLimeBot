...
class Membercount(commands.Cog): 
    ...
    async def setmemberchannel(self, ctx, channel:discord.VoiceChannel):
        ...
        if not guild: 
            await self.client.pg_con.execute("INSERT INTO servers (serverid, mutedrole, logschannel, banned_words, memberschannel) VALUES ($1, $2, $3, $4, $5)", str(ctx.guild.id), "None", "None", "", "None")
